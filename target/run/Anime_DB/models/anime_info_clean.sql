    ...
    create or replace table `analyticsprojects-447201`.`Anime_DB`.`animes_info_bronze`
...
with  __dbt__cte__anime_source as (


select * from `analyticsprojects-447201.Anime_DB.animes_info_raw`
), raw_data as (
    select * from __dbt__cte__anime_source
),
